...
LIBTORRENT_URL2="https://github.com/rakshasa/libtorrent/archive/$LIBTORRENT_VERSION.tar.gz"
...
RTORRENT_URL2="https://github.com/rakshasa/rtorrent/archive/$RTORRENT_VERSION.tar.gz"
