...
LIBTORRENT_URL="http://rtorrent.net/downloads/$LIBTORRENT_VERSION.tar.gz"
LIBTORRENT_URL2="https://github.com/rakshasa/libtorrent/archive/$LIBTORRENT_NAME.tar.gz"
...
RTORRENT_URL2="https://github.com/rakshasa/rtorrent/archive/$RTORRENT_NAME.tar.gz"
